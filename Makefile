...
#BOARD=esp32:esp32:esp32:CPUFreq=240,FlashMode=qio,UploadSpeed=921600
BOARD=esp32:esp32:esp32:CPUFreq=80,FlashMode=qio,UploadSpeed=460800
PORT = /dev/ttyUSB0
#PORT = /dev/ttyACM0

# Default to an Uno if nothing is specified
